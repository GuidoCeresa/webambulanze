...
grails.plugins.springsecurity.userLookup.authorityJoinClassName = 'webambulanze.UtenteRuolo'
grails.plugins.springsecurity.authority.className = 'webambulanze.Ruolo'
