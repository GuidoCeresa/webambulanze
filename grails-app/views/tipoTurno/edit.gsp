...
<html>
	...
	<body>
		<a href="#edit-tipoTurno" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-tipoTurno" class="content scaffold-edit" role="main">
            <h1><g:message code="tipoTurno.edit.label" default="Modifica tipoTurno"/></h1>
			<g:if test="${flash.message}">
			<div class="message" role="status">${flash.message}</div>
			</g:if>
			<g:hasErrors bean="${tipoTurnoInstance}">
			<ul class="errors" role="alert">
				<g:eachError bean="${tipoTurnoInstance}" var="error">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${tipoTurnoInstance?.version}" />
				<fieldset class="form">
