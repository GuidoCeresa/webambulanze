...
<html>
	...
	<body>
		<a href="#create-tipoTurno" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-tipoTurno" class="content scaffold-create" role="main">
            <h1><g:message code="tipoTurno.create.label" default="Crea tipoTurno"/></h1>
