...
<html>
	...
	<body>
		<a href="#edit-funzione" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-funzione" class="content scaffold-edit" role="main">
            <h1><g:message code="funzione.edit.label" default="Modifica funzione"/></h1>
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${funzioneInstance?.version}" />
				<fieldset class="form">
