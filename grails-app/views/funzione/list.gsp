...
<body>
<a href="#list-funzione" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-funzione" class="content scaffold-list" role="main">
    <h1><g:message code="funzione.list.label" default="Elenco funzione"/></h1>
    ...
    <table>
        ...
        <tbody>
        <g:each in="${funzioneInstanceList}" status="i" var="funzioneInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <amb:rigaLista campiLista="${campiLista}" rec="${funzioneInstance}" campiExtra="${campiExtra}"></amb:rigaLista>
            </tr>
        </g:each>
        </tbody>
    </table>

    <g:if test="${funzioneInstanceTotal}">
        <div class="pagination">
            <g:paginate total="${funzioneInstanceTotal}"/>
        </div>
    </g:if>
</div>
</body>
