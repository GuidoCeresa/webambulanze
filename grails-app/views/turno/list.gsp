...
<body>
<a href="#list-turno" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-turno" class="content scaffold-list" role="main">
    <h1><g:message code="turno.list.label" default="Elenco turno"/></h1>
    ...
    <table>
        ...
        <g:each in="${turnoInstanceList}" status="i" var="turnoInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <amb:rigaLista campiLista="${campiLista}" rec="${turnoInstance}" campiExtra="${campiExtra}"></amb:rigaLista>
            </tr>
        </g:each>
        </tbody>
    </table>

    <g:if test="${turnoInstanceTotal}">
