...
<body>
<a href="#create-militestatistiche" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-militestatistiche" class="content scaffold-create" role="main">
    <h1><g:message code="militestatistiche.create.label" default="Crea militestatistiche"/></h1>
