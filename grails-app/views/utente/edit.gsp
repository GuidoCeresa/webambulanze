...
<html>
	...
	<body>
		<a href="#edit-utente" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-utente" class="content scaffold-edit" role="main">
            <h1><g:message code="utente.edit.label" default="Modifica utente"/></h1>
