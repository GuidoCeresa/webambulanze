...
<body>
<a href="#list-utente" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-utente" class="content scaffold-list" role="main">
    <h1><g:message code="utente.list.label" default="Elenco utente"/></h1>
    ...
    <table>
        ...
        <g:each in="${utenteInstanceList}" status="i" var="utenteInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <amb:rigaLista campiLista="${campiLista}" rec="${utenteInstance}" campiExtra="${campiExtra}"></amb:rigaLista>
            </tr>
        </g:each>
        </tbody>
    </table>

    <g:if test="${utenteInstanceTotal}">
