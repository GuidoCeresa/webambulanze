...
<body>
<a href="#list-utenteRuolo" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-utenteRuolo" class="content scaffold-list" role="main">
    <h1><g:message code="utenteRuolo.list.label" default="Elenco utenteRuolo"/></h1>
    ...
    <table>
        ...
        <tbody>
        <g:each in="${utenteRuoloInstanceList}" status="i" var="utenteRuoloInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <amb:rigaLista campiLista="${campiLista}" rec="${utenteRuoloInstance}" campiExtra="${campiExtra}"></amb:rigaLista>
            </tr>
        </g:each>
        </tbody>
    </table>

    <g:if test="${utenteRuoloInstanceTotal}">
        <div class="pagination">
            <g:paginate total="${utenteRuoloInstanceTotal}"/>
        </div>
    </g:if>
</div>
</body>
