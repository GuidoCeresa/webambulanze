...
<body>
<a href="#list-ruolo" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-ruolo" class="content scaffold-list" role="main">
    <h1><g:message code="ruolo.list.label" default="Elenco ruolo"/></h1>
    ...
    <table>
        ...
        <tbody>
        <g:each in="${ruoloInstanceList}" status="i" var="ruoloInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <amb:rigaLista campiLista="${campiLista}" rec="${ruoloInstance}" campiExtra="${campiExtra}"></amb:rigaLista>
            </tr>
        </g:each>
        </tbody>
    </table>

    <g:if test="${ruoloInstanceTotal}">
        <div class="pagination">
            <g:paginate total="${ruoloInstanceTotal}"/>
        </div>
    </g:if>
</div>
</body>
