...
<body>
<a href="#show-ruolo" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div class="nav" role="navigation">
    <ul>
        ...
        <li><g:link class="edit" action="edit" id="${ruoloInstance?.id}">
            <g:message code="ruolo.edit.label" default="Modifica ruolo"/>
        </g:link></li>
    </ul>
</div>
...
<div id="show-ruolo" class="content scaffold-show" role="main">
    ...
    <ol class="property-list ruolo">
        ...
        <li class="fieldcontain">
            <span id="authority-label" class="property-label"><g:message
                    code="ruolo.authority.labelform" default="Authority"/></span>
            
            <span class="property-value" aria-labelledby="authority-label"><g:fieldValue bean="${ruoloInstance}"
    ...
    <g:form>
        <fieldset class="buttons">
            ...
            <g:link class="edit" action="edit" id="${ruoloInstance?.id}">
                <g:message code="ruolo.edit.label" default="Modifica ruolo"/>
            </g:link>
