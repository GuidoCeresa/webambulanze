...
<html>
	...
	<body>
		<a href="#edit-militefunzione" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-militefunzione" class="content scaffold-edit" role="main">
            <h1><g:message code="militefunzione.edit.label" default="Modifica militefunzione"/></h1>
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${militefunzioneInstance?.version}" />
				<fieldset class="form">
