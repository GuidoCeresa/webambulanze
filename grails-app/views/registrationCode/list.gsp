...
<body>
<a href="#list-registrationCode" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-registrationCode" class="content scaffold-list" role="main">
    <h1><g:message code="registrationCode.list.label" default="Elenco registrationCode"/></h1>
    ...
    <table>
        ...
        <g:each in="${registrationCodeInstanceList}" status="i" var="registrationCodeInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                <amb:rigaLista campiLista="${campiLista}" rec="${registrationCodeInstance}" campiExtra="${campiExtra}"></amb:rigaLista>
            </tr>
        </g:each>
        </tbody>
    </table>

    <g:if test="${registrationCodeInstanceTotal}">
