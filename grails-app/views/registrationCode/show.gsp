		...
		<div id="show-registrationCode" class="content scaffold-show" role="main">
			...
			<ol class="property-list registrationCode">
				...
				<li class="fieldcontain">
					<span id="dateCreated-label" class="property-label"><g:message code="registrationCode.dateCreated.labelform" default="Date Created" /></span>
					
						<span class="property-value" aria-labelledby="dateCreated-label"><amb:formatDate date="${registrationCodeInstance?.dateCreated}" /></span>
					
				</li>
			
				<li class="fieldcontain">
					<span id="token-label" class="property-label"><g:message code="registrationCode.token.labelform" default="Token" /></span>
				...
				<li class="fieldcontain">
					<span id="username-label" class="property-label"><g:message code="registrationCode.username.labelform" default="Username" /></span>
