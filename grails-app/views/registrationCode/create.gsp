...
<a href="#create-registrationCode" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="create-registrationCode" class="content scaffold-create" role="main">
    <h1><g:message code="registrationCode.create.label" default="Crea registrationCode"/></h1>
