...
<body>
<a href="#edit-militeturno" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="edit-militeturno" class="content scaffold-edit" role="main">
    <h1><g:message code="militeturno.edit.label" default="Modifica militeturno"/></h1>
    <g:if test="${flash.message}">
        <div class="message" role="status">${flash.message}</div>
    </g:if>
    <g:hasErrors bean="${militeturnoInstance}">
        <ul class="errors" role="alert">
            <g:eachError bean="${militeturnoInstance}" var="error">
    ...
    <g:hiddenField name="version" value="${militeturnoInstance?.version}"/>
    <fieldset class="form">
